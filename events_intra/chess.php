		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<section>
					...
					<div class="content">
						<ul class="alt">
							<li><h2>Head:</h2><h3> - <br><br>-</h3></li>
							<li><h2>Co-Head:</h2><h3> - <br><br>-</h3></li>
						</ul>
					</div>
				</section>
...
$q="select b.class,b.chess as t from olympus_points_b b,olympus_points_g g where b.class=g.class order by t DESC";
										...
										<table class="alt">
											...
											<tbody>
												<tr>
													<?php
													include '../admin/includes/connect.php';
	$q="select b.class,g.chess as t from olympus_points_b b,olympus_points_g g where b.class=g.class order by t DESC";
	$r=mysqli_query($conn,$q);
	while($row=mysqli_fetch_array($r))
	{
													 ?>
